...
beautiful.init("/home/hyperboly/.config/awesome/theme.lua")
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(wallpaper, s, "", 0.8)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "b", function () awful.util.spawn("firefox")         end,
              {description = "Spawn browser", group = "custom"}),
    awful.key({ modkey, "Shift"   }, "d", function () awful.util.spawn("Discord")         end,
              {description = "Spawn Discord", group = "custom"}),
   -- Volume Keys
